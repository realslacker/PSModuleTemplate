...
function Test-DynamicParameter {
    ...
    dynamicparam {
        ...
        New-DynamicParameter -Name AlwaysParam -ValidateSet @( gwmi win32_volume | %{$_.driveletter} | sort ) -DPDictionary $DPDictionary

        #Add dynamic parameters to $DPDictionary
        if ( $ChangeParams.IsPresent ) {

            New-DynamicParameter -Name X1Param1 -ValidateSet 1,2 -mandatory -DPDictionary $DPDictionary
            New-DynamicParameter -Name X1Param2 -DPDictionary $DPDictionary
            New-DynamicParameter -Name X3Param3 -Type DateTime -DPDictionary $DPDictionary
            
        } else {

            New-DynamicParameter -Name OtherParam1 -Mandatory -DPDictionary $DPDictionary
            New-DynamicParameter -Name OtherParam2 -DPDictionary $DPDictionary
            New-DynamicParameter -Name OtherParam3 -Type DateTime -DPDictionary $DPDictionary
